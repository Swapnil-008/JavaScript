...
// console.log(myObj.mySym); // undefined // it gives the value of entity mySum but the type of that entity will string not a symbol, that's why we use above syntax also
// console.log(typeof myObj.mySym); //undefined //string  (if entity in myObj is 'mySym' not '[mySym]')
